...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Students", value: String(students.length), delta: `${students.length} registered`, color: "#6D28D9", icon: "👥" },
      ...
      <div className="grid lg:grid-cols-[1.5fr_1fr] gap-6">
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { label:"Upload PDF", icon:UploadCloud, to:"/admin/upload?type=pdf", color:"#6D28D9" },
